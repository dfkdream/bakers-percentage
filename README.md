...
Baker's percentage를 자동으로 계산해 주는 웹 애플리케이션입니다.

Gemini 3 Pro 의 도움으로 개발하였습니다.

## 주요 기능
* 베이커스 퍼센트 자동 계산
    * 재료 무게를 입력하면 자동으로 베이커스 퍼센트가 계산됩니다.
    * 가루 재료를 여러 개 추가할 수 있습니다.
* 총 중량 자동 계산
* 비율 고정 기능
    * 재료 비율을 고정한 상태에서 각 재료의 무게를 변경할 수 있습니다.
* 마크다운으로 내보내기
* 링크 공유 기능
* 스프레드시트와 유사한 단축키 (Tab, Enter, 방향키)
